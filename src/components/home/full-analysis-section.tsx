    ...
    <section className="section">
      <div className="grid gap-6 lg:grid-cols-12 lg:items-stretch">
        <div className="glass-panel lg:col-span-7 rounded-3xl p-6 sm:p-8">
          <h2 className="text-2xl font-semibold text-zinc-50">Põhjalikum ülevaade</h2>
        ...
        <div className="lg:col-span-5 rounded-3xl border border-white/10 bg-white/[0.02] p-6 sm:p-8">
          <div className="text-sm font-semibold text-zinc-50">Mida sa näed</div>
          <div className="mt-4 grid gap-3">
            ...
            <div className="rounded-2xl border border-emerald-300/20 bg-emerald-400/10 p-4">
              <div className="text-xs text-emerald-200">Detailne analüüs</div>
          ...
          <p className="mt-4 text-xs text-zinc-400">Energiakalkulaator on ülikooli projekt.</p>
        </div>
      </div>
    </section>
  );
