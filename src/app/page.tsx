    ...
    <div className="relative page-bg page-bg-static">
      <main className="relative mx-auto w-full max-w-7xl px-3 pb-14 pt-6 sm:px-6 sm:pb-16 sm:pt-10 lg:px-8 lg:pt-12">
        <section className="relative overflow-hidden rounded-[1.7rem] border border-emerald-300/30 bg-[#050d0a] px-4 py-8 shadow-[0_30px_100px_rgba(0,0,0,0.62)] sm:rounded-[2rem] sm:px-8 sm:py-11 lg:px-10 lg:py-12">
          ...
          <div className="pointer-events-none absolute inset-0 z-0 bg-[linear-gradient(95deg,rgba(5,13,10,0.82)_0%,rgba(5,13,10,0.72)_40%,rgba(5,13,10,0.3)_72%,rgba(5,13,10,0.12)_100%)]" />
          <div className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(circle_at_80%_18%,rgba(16,185,129,0.22),transparent_40%),radial-gradient(circle_at_90%_70%,rgba(45,212,191,0.16),transparent_42%),radial-gradient(circle_at_64%_58%,rgba(99,102,241,0.12),transparent_44%)]" />
